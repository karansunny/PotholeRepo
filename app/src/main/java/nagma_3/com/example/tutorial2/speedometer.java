...
public class speedometer extends AppCompatActivity implements LocationListener{//implementing the Interface LocationListener for receiving notifications when the location has changed
